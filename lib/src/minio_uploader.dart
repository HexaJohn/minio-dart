...
class MinioCustomUploader implements StreamConsumer<List<int>> {
  MinioCustomUploader(this.minio, this.client, this.bucket, this.object,
      this.partSize, this.partNumber, this.metadata, this.uploadId);
